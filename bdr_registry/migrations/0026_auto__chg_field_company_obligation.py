...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.obligation'
        db.alter_column(u'bdr_registry_company', 'obligation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bdr_registry.Obligation']), ignore_constraints=True)

    def backwards(self, orm):

        # Changing field 'Company.obligation'
        db.alter_column(u'bdr_registry_company', 'obligation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bdr_registry.Obligation'], null=True))
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'kedhb7rel8lo1kl1w1w3'", 'max_length': '255'})
        },
        ...
        u'bdr_registry.company': {
            ...
            'obligation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bdr_registry.Obligation']"}),
