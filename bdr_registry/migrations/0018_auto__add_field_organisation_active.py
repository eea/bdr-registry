...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.active'
        db.add_column('bdr_registry_organisation', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.active'
        db.delete_column('bdr_registry_organisation', 'active')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'0313vo16exe8pi7odkps'", 'max_length': '255'})
        },
