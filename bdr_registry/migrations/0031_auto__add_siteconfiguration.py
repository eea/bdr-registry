...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bdr_registry_siteconfiguration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reporting_year', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'bdr_registry', ['SiteConfiguration'])


    def backwards(self, orm):
        # Deleting model 'SiteConfiguration'
        db.delete_table(u'bdr_registry_siteconfiguration')
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'7dbeq0uuxo644gxugx8x'", 'max_length': '255'})
        },
