...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field admins on 'Obligation'
        m2m_table_name = db.shorten_name(u'bdr_registry_obligation_admins')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('obligation', models.ForeignKey(orm[u'bdr_registry.obligation'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['obligation_id', 'user_id'])


        # Changing field 'Obligation.bcc'
        db.alter_column(u'bdr_registry_obligation', 'bcc', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Removing M2M table for field admins on 'Obligation'
        db.delete_table(db.shorten_name(u'bdr_registry_obligation_admins'))


        # Changing field 'Obligation.bcc'
        db.alter_column(u'bdr_registry_obligation', 'bcc', self.gf('post_office.fields.CommaSeparatedEmailField')())
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'3eojeer8pmn046z9f5wy'", 'max_length': '255'})
        },
