...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteConfiguration.notify_add_file_template'
        db.add_column(u'bdr_registry_siteconfiguration', 'notify_add_file_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6, related_name='notify_add_file_conf', to=orm['post_office.EmailTemplate']),
                      keep_default=False)

        # Adding field 'SiteConfiguration.notify_add_feedback_template'
        db.add_column(u'bdr_registry_siteconfiguration', 'notify_add_feedback_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=7, related_name='notify_add_feedback_conf', to=orm['post_office.EmailTemplate']),
                      keep_default=False)

        # Adding field 'SiteConfiguration.notify_release_template'
        db.add_column(u'bdr_registry_siteconfiguration', 'notify_release_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=8, related_name='notify_release_conf', to=orm['post_office.EmailTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteConfiguration.notify_add_file_template'
        db.delete_column(u'bdr_registry_siteconfiguration', 'notify_add_file_template_id')

        # Deleting field 'SiteConfiguration.notify_add_feedback_template'
        db.delete_column(u'bdr_registry_siteconfiguration', 'notify_add_feedback_template_id')

        # Deleting field 'SiteConfiguration.notify_release_template'
        db.delete_column(u'bdr_registry_siteconfiguration', 'notify_release_template_id')
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'r9y26zp5yr5sr69rocut'", 'max_length': '255'})
        },
        ...
        u'bdr_registry.siteconfiguration': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notify_add_feedback_template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notify_add_feedback_conf'", 'to': u"orm['post_office.EmailTemplate']"}),
            'notify_add_file_template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notify_add_file_conf'", 'to': u"orm['post_office.EmailTemplate']"}),
            'notify_release_template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notify_release_conf'", 'to': u"orm['post_office.EmailTemplate']"}),
            'reporting_year': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'self_register_email_template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'self_register_conf'", 'to': u"orm['post_office.EmailTemplate']"})
        },
