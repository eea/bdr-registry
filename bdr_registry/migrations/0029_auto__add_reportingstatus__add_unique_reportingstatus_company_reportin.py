...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportingStatus'
        db.create_table(u'bdr_registry_reportingstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reporting_statuses', to=orm['bdr_registry.Company'])),
            ('reporting_year', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reporting_statuses', to=orm['bdr_registry.ReportingYear'])),
            ('reported', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'bdr_registry', ['ReportingStatus'])

        # Adding unique constraint on 'ReportingStatus', fields ['company', 'reporting_year']
        db.create_unique(u'bdr_registry_reportingstatus', ['company_id', 'reporting_year_id'])

        # Adding model 'ReportingYear'
        db.create_table(u'bdr_registry_reportingyear', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True)),
        ))
        db.send_create_signal(u'bdr_registry', ['ReportingYear'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReportingStatus', fields ['company', 'reporting_year']
        db.delete_unique(u'bdr_registry_reportingstatus', ['company_id', 'reporting_year_id'])

        # Deleting model 'ReportingStatus'
        db.delete_table(u'bdr_registry_reportingstatus')

        # Deleting model 'ReportingYear'
        db.delete_table(u'bdr_registry_reportingyear')
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'s3tdcm0qlo55h2cri371'", 'max_length': '255'})
        },
