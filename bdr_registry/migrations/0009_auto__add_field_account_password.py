...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bdr_registry_account', 'password',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bdr_registry_account', 'password')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'sd9oyfdsns1umpzdpivw'", 'max_length': '255'})
        },
