...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bdr_registry_person', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Person.title'
        db.alter_column(u'bdr_registry_person', 'title', self.gf('django.db.models.fields.CharField')(default='N/A', max_length=255))
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'r7unk3ve71pzhm92n4l1'", 'max_length': '255'})
        },
