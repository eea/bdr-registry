...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Obligation.email_template'
        db.add_column(u'bdr_registry_obligation', 'email_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['post_office.EmailTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Obligation.email_template'
        db.delete_column(u'bdr_registry_obligation', 'email_template_id')
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ckmiivtjzfal1q0epnic'", 'max_length': '255'})
        },
