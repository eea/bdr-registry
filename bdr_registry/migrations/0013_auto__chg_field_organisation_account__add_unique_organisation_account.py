...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organisation.account'
        db.alter_column('bdr_registry_organisation', 'account_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bdr_registry.Account'], unique=True, null=True))
        # Adding unique constraint on 'Organisation', fields ['account']
        db.create_unique('bdr_registry_organisation', ['account_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Organisation', fields ['account']
        db.delete_unique('bdr_registry_organisation', ['account_id'])


        # Changing field 'Organisation.account'
        db.alter_column('bdr_registry_organisation', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bdr_registry.Account'], null=True))
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'0zwfbfxluxryxpslpj20'", 'max_length': '255'})
        },
