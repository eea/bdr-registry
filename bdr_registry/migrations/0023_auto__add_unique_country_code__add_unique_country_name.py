...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'bdr_registry_country', ['code'])

        # Adding unique constraint on 'Country', fields ['name']
        db.create_unique(u'bdr_registry_country', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Country', fields ['name']
        db.delete_unique(u'bdr_registry_country', ['name'])

        # Removing unique constraint on 'Country', fields ['code']
        db.delete_unique(u'bdr_registry_country', ['code'])
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'p3g9qqyp97kz1opcd2ri'", 'max_length': '255'})
        },
        ...
        u'bdr_registry.organisation': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'organisation'", 'unique': 'True', 'null': 'True', 'to': u"orm['bdr_registry.Account']"}),
