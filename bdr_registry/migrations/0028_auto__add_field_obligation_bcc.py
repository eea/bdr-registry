...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Obligation.bcc'
        db.delete_column(u'bdr_registry_obligation', 'bcc')
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'swxv2dgcm5mkglteym2x'", 'max_length': '255'})
        },
