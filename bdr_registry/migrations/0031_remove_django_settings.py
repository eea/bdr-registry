...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_table(u'django_settings_string')
        db.delete_table(u'django_settings_integer')
        db.delete_table(u'django_settings_positiveinteger')
        db.delete_table(u'django_settings_email')
        db.delete_table(u'django_settings_setting')
