...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bdr_registry_organisation', 'comments',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bdr_registry_organisation', 'comments')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'jji71nbczrsidpujszgr'", 'max_length': '255'})
        },
