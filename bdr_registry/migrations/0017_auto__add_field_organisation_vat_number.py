...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.vat_number'
        db.add_column('bdr_registry_organisation', 'vat_number',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.vat_number'
        db.delete_column('bdr_registry_organisation', 'vat_number')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'p64ronc4n1iw8dkl0jln'", 'max_length': '255'})
        },
