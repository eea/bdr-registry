...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bdr_registry_person', 'email2',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.phone2'
        db.add_column('bdr_registry_person', 'phone2',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.phone3'
        db.add_column('bdr_registry_person', 'phone3',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bdr_registry_person', 'email2')

        # Deleting field 'Person.phone2'
        db.delete_column('bdr_registry_person', 'phone2')

        # Deleting field 'Person.phone3'
        db.delete_column('bdr_registry_person', 'phone3')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ipxg21gsk8mqrazmtk2p'", 'max_length': '255'})
        },
