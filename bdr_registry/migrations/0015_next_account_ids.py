...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        NextAccountId = orm['bdr_registry.NextAccountId']
        for obligation in orm['bdr_registry.Obligation'].objects.all():
            NextAccountId.objects.create(next_id=30000, obligation=obligation)

    def backwards(self, orm):
        orm['bdr_registry.NextAccountId'].objects.all().delete()
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'n114rv7e7hqctclzqq2g'", 'max_length': '255'})
        },
