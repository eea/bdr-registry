...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganisationNameHistory'
        db.create_table('bdr_registry_organisationnamehistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('organisation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='namehistory', to=orm['bdr_registry.Organisation'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('bdr_registry', ['OrganisationNameHistory'])


    def backwards(self, orm):
        # Deleting model 'OrganisationNameHistory'
        db.delete_table('bdr_registry_organisationnamehistory')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'57hb45pm5l4ev2jdfz57'", 'max_length': '255'})
        },
