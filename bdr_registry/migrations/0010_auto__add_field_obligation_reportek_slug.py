...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Obligation.reportek_slug'
        db.add_column('bdr_registry_obligation', 'reportek_slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Obligation.reportek_slug'
        db.delete_column('bdr_registry_obligation', 'reportek_slug')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'t467ry9yq6w9opzl4189'", 'max_length': '255'})
        },
