...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NextAccountId'
        db.create_table('bdr_registry_nextaccountid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('next_id', self.gf('django.db.models.fields.IntegerField')()),
            ('obligation', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bdr_registry.Obligation'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal('bdr_registry', ['NextAccountId'])


    def backwards(self, orm):
        # Deleting model 'NextAccountId'
        db.delete_table('bdr_registry_nextaccountid')
    ...
    models = {
        ...
        'bdr_registry.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'21yowfeo6nq6i6chdhhu'", 'max_length': '255'})
        },
