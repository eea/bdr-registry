...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteConfiguration.self_register_email_template'
        db.add_column(u'bdr_registry_siteconfiguration', 'self_register_email_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post_office.EmailTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteConfiguration.self_register_email_template'
        db.delete_column(u'bdr_registry_siteconfiguration', 'self_register_email_template_id')
    ...
    models = {
        ...
        u'bdr_registry.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'rbz9z1htm2o6lvmygsw3'", 'max_length': '255'})
        },
