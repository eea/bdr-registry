...
management_js = Bundle(
    *MANAGEMENT_JS_ASSETS, filters="jsmin", output="management_packed.js"
)
management_css = Bundle(
    *MANAGEMENT_CSS_ASSETS, filters="cssmin", output="management_packed.css"
)
