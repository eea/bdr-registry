...
company_patterns = [
    path("add/", views.CompanyCreate.as_view()),
    path("<int:pk>/", management_views.CompaniesUpdateView.as_view(), name="company"),
    path(
        "<int:pk>/update/",
...
person_patterns = [
    path("<int:pk>/", management_views.PersonView.as_view(), name="person"),
    path(
        "<int:pk>/update/", management_views.PersonEdit.as_view(), name="person_update"
    ),
    path(
        "<int:pk>/delete/",
...
urlpatterns = [
    ...
    path("self_register/", views.SelfRegister.as_view(), name="self_register"),
    path(
        "self_register_hdv/", views.SelfRegisterHDV.as_view(), name="self_register_hdv"
    ),
    path(
        "self_register/done/",
    ...
    path(
        "management/",
        include(("bdr_management.urls", "bdr_manangement"), namespace="management"),
    ),
    ...
    # Api views
    path(
        "api/company/obligation/<slug:obligation_slug>/",
