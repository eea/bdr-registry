...
urlpatterns = [
    ...
    path('companies/<int:cpk>/persons/<int:pk>/',
        views.PersonFromCompanyView.as_view(),
        name='person_from_company'),
    path('companies/<int:cpk>/persons/<int:pk>/edit/',
        views.PersonFromCompanyEdit.as_view(),
        name='person_from_company_edit'),
    path('companies/(<int:cpk>/persons/<int:pk>/delete/',
    ...
    path('actions/',
        ...
        name='actions'),
    path('actions/copy-report-status/',
