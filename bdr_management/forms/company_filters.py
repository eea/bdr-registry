...
class CompanyFilters(Form):
    ...
    country = ModelChoiceField(queryset=Country.objects.all(), empty_label="All")

    obligation = ModelChoiceField(queryset=Obligation.objects.all(), empty_label="All")
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["obligation"].queryset = self.fields["obligation"].queryset.filter(
            pk__in=obligations
        )
