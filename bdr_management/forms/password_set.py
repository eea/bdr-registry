...
class AccountForm(ModelForm):
    ...
    username = ModelChoiceField(
        ...
        to_field_name="uid",
        error_messages={
            "invalid_choice": "This user does not exist in the application."
        },
        widget=TextInput(),
    )
...
class SetPasswordForm(Form):
    ...
    new_password1 = CharField(label=("New password"), widget=PasswordInput)
    new_password2 = CharField(label=("New password confirmation"), widget=PasswordInput)
